...
component_id = "source_a_dropdown"
...
layout = dash.html.Div(
    ...
    children= [
        ...
        dash.html.H2('Source A (Top)'),

        dash.dcc.Dropdown(

            id='source-a-dropdown-controler',

            value = "Electric, CHP, Heat Plants",
...
def update_sourcea_dropdown(nav_opt):
